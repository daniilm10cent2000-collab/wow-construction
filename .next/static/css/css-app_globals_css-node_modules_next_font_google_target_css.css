...
:root {
  ...
  --industrial-bg: #0c0c0e;
  --industrial-sidebar: #121214;
  --industrial-topbar: #121214;
  --industrial-border: #2a2a2e;
  --industrial-muted: #71717a;
...
.hover\:bg-industrial-border:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(42 42 46 / var(--tw-bg-opacity, 1));
}
.hover\:bg-industrial-border\/50:hover {
  background-color: rgb(42 42 46 / 0.5);
}
